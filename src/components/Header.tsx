            ...
            <div>
              ...
              <div className="flex items-center gap-x-2">
                ...
                <Link href={"https://www.youtube.com/channel/UCNlSN31zKSfnmjBgRirM6NA"} target="_blank">
                  <div className="rounded-md bg-lightBlue px-1 dark:bg-blueCus">
                    <IconYoutube />
                  </div>
                </Link>
              </div>
          ...
          {windowWidth < 1024 && (
            <div className="flex flex-wrap justify-between gap-5 text-start">
              <div className="w-full md:w-1/3">
                <p className="text-sm font-semibold">BIOGRAPHY</p>
                <p>
                  I am an SMK student living outside Java, balancing studies with freelancing. This journey has taught me adaptability, discipline,
